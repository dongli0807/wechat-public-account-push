export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxabe841b223430eeb",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "8e41eabb95e42c8e4b3b1a5ff783c221",
  ...
  USERS: [
    {
      ...
      id: "o0U3L54ueaWTGX-62wk3AaTE3a_4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "w87Yby7nHlf0lkziYvUR8vr-TQxitIXo15UCoOH8-k0",
      // 所在省份
      province: "湖南",
      // 所在城市
      city: "娄底",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "1998", "date": "09-26"},
